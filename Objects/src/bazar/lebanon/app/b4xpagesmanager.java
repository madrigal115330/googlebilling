...
public class b4xpagesmanager extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bazar.lebanon.app.b4xpagesmanager");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bazar.lebanon.app.b4xpagesmanager.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public bazar.lebanon.app.b4xorderedmap _idtob4xpage = null;
public bazar.lebanon.app.b4xorderedmap _rootb4xtopage = null;
public anywheresoftware.b4j.object.JavaObject _context = null;
public bazar.lebanon.app.b4xset _mstackofpageids = null;
...
public bazar.lebanon.app.b4xmainpage _mainpage = null;
...
public bazar.lebanon.app.b4xpagesmanager._b4xpageparent Parent;
public void Initialize() {
IsInitialized = true;
B4XPage = new Object();
Id = "";
...
IsFirst = false;
Parent = new bazar.lebanon.app.b4xpagesmanager._b4xpageparent();
}
@Override
		public String toString() {
			return BA.TypeToString(this, false);
...
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi = null;
...
public bazar.lebanon.app.b4xpagesmanager._b4amenuitem  _addmenuitem(Object _b4xpage,Object _title) throws Exception{
bazar.lebanon.app.b4xpagesmanager._b4amenuitem _mi = null;
...
_mi = new bazar.lebanon.app.b4xpagesmanager._b4amenuitem();
...
_findpifromb4xpage(_b4xpage).Parent /*bazar.lebanon.app.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Add((Object)(_mi));
...
__c.LogImpl("98257539",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
_pi = (bazar.lebanon.app.b4xpagesmanager._b4xpageinfo)(group5.Get(index5));
...
__c.LogImpl("98126485","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
_idtob4xpage = new bazar.lebanon.app.b4xorderedmap();
 //BA.debugLineNum = 24;BA.debugLine="Private RootB4XToPage As B4XOrderedMap";
_rootb4xtopage = new bazar.lebanon.app.b4xorderedmap();
...
_mstackofpageids = new bazar.lebanon.app.b4xset();
...
_mainpage = new bazar.lebanon.app.b4xmainpage();
...
__c.LogImpl("98519684","Only top page can be closed",0);
...
__c.LogImpl("98519687","First page cannot be closed",0);
...
public String  _closepageimpl(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public boolean  _closerequestexists(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public bazar.lebanon.app.b4xpagesmanager._b4xpageinfo  _createb4xpageinfo(Object _b4xpage,String _id,boolean _created,Object _title) throws Exception{
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _t1 = null;
...
_t1 = new bazar.lebanon.app.b4xpagesmanager._b4xpageinfo();
...
public bazar.lebanon.app.b4xpagesmanager._b4xpageparent  _createb4xpageparent(Object _nativetype) throws Exception{
bazar.lebanon.app.b4xpagesmanager._b4xpageparent _t1 = null;
...
_t1 = new bazar.lebanon.app.b4xpagesmanager._b4xpageparent();
...
{
final anywheresoftware.b4a.BA.IterableList group4 = _pi.Parent /*bazar.lebanon.app.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ ;
final int groupLen4 = group4.getSize()
;int index4 = 0;
;
for (; index4 < groupLen4;index4++){
_mi = (bazar.lebanon.app.b4xpagesmanager._b4amenuitem)(group4.Get(index4));
...
public String  _createpageifneeded(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
public String  _createpageimpl(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*bazar.lebanon.app.b4xpagesmanager._b4xpageparent*/  = _createb4xpageparent((Object)(_mmainform.getObject()));
 //BA.debugLineNum = 384;BA.debugLine="pi.Parent.MenuItems.Initialize";
_pi.Parent /*bazar.lebanon.app.b4xpagesmanager._b4xpageparent*/ .MenuItems /*anywheresoftware.b4a.objects.collections.List*/ .Initialize();
 //BA.debugLineNum = 392;BA.debugLine="End Sub";
return "";
}
public bazar.lebanon.app.b4xpagesmanager._b4xpageinfo  _findpifromb4xpage(Object _page) throws Exception{
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (bazar.lebanon.app.b4xpagesmanager._b4xpageinfo)(group1.Get(index1));
...
if (true) return (bazar.lebanon.app.b4xpagesmanager._b4xpageinfo)(__c.Null);
...
public bazar.lebanon.app.b4xpagesmanager._b4xpageinfo  _getpagefromid(String _id) throws Exception{
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi = null;
...
_pi = (bazar.lebanon.app.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ ((Object)(_id.toLowerCase())));
 //BA.debugLineNum = 400;BA.debugLine="If pi = Null Then";
if (_pi== null) { 
 //BA.debugLineNum = 401;BA.debugLine="Log(\"Error: page id not found: \" & id)";
__c.LogImpl("99175043","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("99175044","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
public bazar.lebanon.app.b4xpagesmanager._b4xpageinfo  _getpageinfofromroot(anywheresoftware.b4a.objects.B4XViewWrapper _root) throws Exception{
...
if (true) return (bazar.lebanon.app.b4xpagesmanager._b4xpageinfo)(_rootb4xtopage._get /*Object*/ ((Object)(_root.getObject())));
 //BA.debugLineNum = 409;BA.debugLine="End Sub";
return null;
}
public bazar.lebanon.app.b4xpagesmanager._b4xpageinfo  _gettoppage() throws Exception{
...
if (true) return (bazar.lebanon.app.b4xpagesmanager._b4xpageinfo)(_idtob4xpage._get /*Object*/ (_mstackofpageids._aslist /*anywheresoftware.b4a.objects.collections.List*/ ().Get((int) (_mstackofpageids._getsize /*int*/ ()-1))));
 //BA.debugLineNum = 595;BA.debugLine="End Sub";
return null;
}
public void  _handlecloserequest(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
ResumableSub_HandleCloseRequest rsub = new ResumableSub_HandleCloseRequest(this,_pi);
rsub.resume(ba, null);
}
public static class ResumableSub_HandleCloseRequest extends BA.ResumableSub {
public ResumableSub_HandleCloseRequest(bazar.lebanon.app.b4xpagesmanager parent,bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) {
this.parent = parent;
this._pi = _pi;
}
bazar.lebanon.app.b4xpagesmanager parent;
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi;
...
__c.LogImpl("98060955","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
public String  _logevent(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi,String _ev) throws Exception{
String _msg = "";
...
public String  _raiseevent(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
public Object  _raiseeventwithresult(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _targetpage,String _subname,Object[] _params) throws Exception{
int _length = 0;
...
_pi.Parent /*bazar.lebanon.app.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ .setTitle(BA.ObjectToCharSequence(_title));
 //BA.debugLineNum = 367;BA.debugLine="End Sub";
return "";
}
public String  _showpage(String _id) throws Exception{
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi = null;
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _top = null;
...
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi = null;
bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pagetoremove = null;
...
public String  _showpageimpl(bazar.lebanon.app.b4xpagesmanager._b4xpageinfo _pi) throws Exception{
...
_pi.Parent /*bazar.lebanon.app.b4xpagesmanager._b4xpageparent*/ .NativeType /*anywheresoftware.b4a.objects.ActivityWrapper*/ .setTitle(BA.ObjectToCharSequence(_pi.Title /*Object*/ ));
